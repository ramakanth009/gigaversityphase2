...
import React from "react";
import Heromain from "../../../Elements/Heromain/heromain";
import heroImage from "../../../../Assets/gs-hero.png";
...
const Hero = () => {
  return (
    <Heromain
      backgroundImage={heroImage}
      title="Gigaversity "
      highlightText="Graphic Designing Program "
      title2="Create. Innovate. Transform Ideas into Visual Masterpieces.."
      subtitle="Graphic design shapes the way the world communicates, with demand surging across industries from branding to digital media—prepare for a field where your creativity will inspire and captivate audiences globally."
